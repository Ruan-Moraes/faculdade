create database FaculdadeImplementacao;
use FaculdadeImplementacao;
...
insert into Cliente (idCliente, nome, telefone, email, endereco)
values (1, 'Alice de Souza', '(41) 99854-5648', 'alice.s@email.com.br', 'Rua das Flores, 3578, Curitiba - PR'),
       (2, 'Mario Vicente', '(11) 99527-3721', 'mario.v@email.com.br',
        'Avenida Ipiranga, 1246, apto. 201, São Paulo - SP'),
       (3, 'Maria Helena Mantovani', '(21) 99763-1213', 'maria.m@email.com.br',
        'Rua Vicente Machado, 10503, apto. 1007, Rio de Janeiro - RJ'),
       ...
       (6, 'Luciano Tucolo', '(51) 99234-5458', 'luciano.t@email.com.br',
        'Avenida Uruguai, 3152, apto. 2202, Porto Alegre - RS'),
       (7, 'Paula Roberta Vitorino', '(65) 98953-7828', 'paula.v@email.com.br', 'Rua dos Açudes, 1029, Cuiabá - MT'),
       (8, 'Guilherme Koeriche', '(63) 99315-6264', 'guilherme.k@email.com.br',
        'Avenida Brasil, 953, apto. 709, Palmas - TO'),
...
insert into Editora (idEditora, nome, telefone, email, endereco)
values (1, 'Companhia da Leitura', '(11) 3854-2946', 'companhiadaleitura@email.com.br',
        'Avenida Brasil, 458, São Paulo - SP'),
       (2, 'Arco da Velha', '(21) 3916-5859', 'arcodavelha@email.com.br',
        'Rua das Estradas de Pedras, 568, sala 12, Rio de Janeiro - RJ'),
       (3, 'Mais Informática', '(62) 3425-2064', 'maisinformatica@email.com.br',
        'Avenida Linda de Goiás, 627, Goiânia - GO'),
       (4, 'Sexta dos Estudos', '(41) 3789-3438', 'sextadosestudos@email.com.br',
        'Rua Sete de Setembro, 1568, sala 29, Curitiba - PR'),
       (5, 'Ciência da Informação', '(11) 3678-1284', 'cienciadainformacao@email.com.br',
        'Rua Vinte e Cinco de Maio, 678, sala 3, São Paulo - SP');

insert into Livro (idLivro, idEditora, titulo, autor, ano, ISBN, preco)
values (1, 1, 'Minha Faculdade Vai Me Enlouquecer', 'Murilo dos Santos', 2023, '978-0-1548-6458-4', 29.90),
       ...
       (8, 3, 'Banco de Dados: Aprenda de Forma Simples e Fácil', 'Pedro Antônio Zamba', 2018, '942-0-8125-6479-8',
        119.90),
       ...
       (15, 5, 'Inteligência Artificial Aplicada a Dados', 'Marli Terezinha Girotto', 2023, '694-0-1973-4826-7',
        169.90);

insert into Estoque (idLivro, quantidade)
values (1, 35),
       (2, 20),
       (3, 50),
       (4, 50),
...
insert into Pedido (idPedido, idCliente, dataPedido, valorPedido)
values (1, 1, '2021-09-09', 42.90),
...
select count(*) as 'Quantidade de Livros Cadastrados'
from Livro;
...
select e.nome as 'Nome da Editora', l.titulo as 'Título do Livro'
from Editora e
...
select e.nome as 'Nome da Editora', avg(l.preco) as 'Média de Preço'
from Editora e
         inner join Livro l on e.idEditora = l.idEditora
group by e.nome;

# Implemente uma consulta para listar o nome de todos os clientes e a quantidade de livros comprados pelos mesmos. Para isso, utilize o comando group by.

select c.nome as 'Nome do Cliente', count(ip.idLivro) as 'Quantidade de Livros Comprados'
from Cliente c
